...
import mongoose from "mongoose"; // For Mongoose models (AITeacher, etc.)
...
// Load env vars (works locally; on Vercel real env vars override these)
...
// Explicit DB name (can override via env)
const dbName = process.env.MONGODB_DB_NAME || "learn_platform";
...
async function initDb() {
  try {
    ...
    console.log("MongoDB (MongoClient) Connected to DB:", dbName);

    // Mongoose (for models like AITeacher)
